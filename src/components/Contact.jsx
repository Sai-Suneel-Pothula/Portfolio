    ...
    <div>
        ...
        <div className="contactList1">
          ...
          <div className="contactIcons">
            ...
            <div className="contactItem">
              ...
              <div className="contactDetails">
                <h3>Email</h3>
                <p>tatikayalapradeep36@gmail.com</p>
              </div>
            </div>
            <div className="contactItem">
              ...
              <div className="contactDetails">
                <h3>LinkedIn</h3>
                <a
                  href="https://www.linkedin.com/in/pradeep-tatikayala-6b8772256/"
                  target="_blank"
      ...
      <div className="footer">
        <p className="footerContent">
          Created by Pradeep Tatikayala | <FaCopyright className="copyrightIcon" />{" "}
